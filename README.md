...
- [🤖AI实用效率工具](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#ai%E5%AE%9E%E7%94%A8%E6%95%88%E7%8E%87%E5%B7%A5%E5%85%B7)
- [⛳AI模型管理工具](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#ai%E6%A8%A1%E5%9E%8B%E7%AE%A1%E7%90%86%E5%B7%A5%E5%85%B7)
- [🌌AI短剧生成工具](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#ai%E7%9F%AD%E5%89%A7%E7%94%9F%E6%88%90%E5%B7%A5%E5%85%B7)
...
- [🎊Markdown文件转换器](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#markdown%E6%96%87%E4%BB%B6%E8%BD%AC%E6%8D%A2%E5%99%A8)
...
- [🥠实用OCR工具](https://github.com/YSGStudyHards/Awesome-Tools/blob/main/README.md#%E5%AE%9E%E7%94%A8ocr%E5%B7%A5%E5%85%B7)
- [🎡在线工具箱](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#%E5%9C%A8%E7%BA%BF%E5%B7%A5%E5%85%B7%E7%AE%B1)
- [🍎Mac实用工具箱](https://github.com/YSGStudyHards/Awesome-Tools/blob/main/README.md#mac%E5%AE%9E%E7%94%A8%E5%B7%A5%E5%85%B7%E7%AE%B1)
...
- [🎑Windows桌面管理工具](https://github.com/YSGStudyHards/Awesome-Tools/blob/main/README.md#windows%E6%A1%8C%E9%9D%A2%E7%AE%A1%E7%90%86%E5%B7%A5%E5%85%B7)
...
- [🧳堡垒机工具](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#%E5%A0%A1%E5%9E%92%E6%9C%BA%E5%B7%A5%E5%85%B7)
- [📯实用建站工具](https://github.com/YSGStudyHards/Awesome-Tools#%E5%AE%9E%E7%94%A8%E5%BB%BA%E7%AB%99%E5%B7%A5%E5%85%B7)
- [⚒Kafka管理工具](https://github.com/YSGStudyHards/Awesome-Tools/blob/main/README.md#kafka%E7%AE%A1%E7%90%86%E5%B7%A5%E5%85%B7)
- [🖼图像处理软件](https://github.com/YSGStudyHards/Awesome-Tools/tree/main?tab=readme-ov-file#%E5%9B%BE%E5%83%8F%E5%A4%84%E7%90%86%E8%BD%AF%E4%BB%B6)
...
| OpenAI Codex | OpenAI Codex 是一个 AI 编程代理（AI Coding Agent），目标不是帮你补全代码"，而是直接参与并完成整个开发任务——写代码、修 Bug、跑测试、提 Pull Request。简单来说，你提需求，Codex 负责实现。 | https://openai.com/zh-Hans-CN/codex |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| AI Dictation | AI Dictation 是一款采用 MIT 许可证的开源语音输入和语音转文字应用，支持 macOS、Windows、iPhone、iPad 和 Android；在受支持的设备上可使用离线语音识别，并可选择云端转录和文本整理。 | [官网](https://aidictation.com) / [GitHub](https://github.com/writingmate/aidictation) |
...
| Cate | Cate 是一款开源的无限画布桌面 IDE，基于 Electron + React + TypeScript 构建。代码编辑器（Monaco）、终端（xterm.js）、内嵌浏览器、文档预览和 AI Agent（Claude Code）面板可以自由分布在可缩放的空间画布上，代替传统的窗口和标签页堆叠。面板支持浮动、停靠为标签页/分屏，或分离为独立系统窗口，布局按项目文件夹自动保存。MIT 协议，支持 macOS、Windows、Linux。 | https://github.com/0-AI-UG/cate |
|  |  |  |
|  |  |  |
...
| ZeroNote（秒开笔记） | 秒开笔记是一款零摩擦、零信任、纯前端的在线写作笔记，是你瞬时零感的写作缓冲带。支持 Markdown 与纯文本，无需注册、无需云端，内容仅保存在浏览器本地，随开随写。 | https://zeronote.online |
| Browser SOP Builder | 免费开源的纯前端 SOP 编写工具，支持步骤、负责人、检查项以及 Markdown 复制和下载。无需注册，内容不上传服务器。 | https://max-agent-hub.github.io/browser-sop-builder/ |
| Notebook | Notebook 一款界面简洁，使用方便的笔记App。这款在线记事本可记录文字、图片、音频、视频等内容，并同步到云端，随时记录笔记。 | https://www.zoho.com.cn/notebook |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
| WindEdit | 一款高性能文本编辑器，适用于大型文件和长行文本。 | https://github.com/kingToolbox/WindEdit |
|  |  |  |
...
| Gitnuro | Gitnuro 适用于需要跨平台、开源且易于使用的 Git 客户端的开发者和团队。它支持多种操作系统，包括 Linux、Windows 和 macOS，可以满足不同开发环境下的需求。无论是进行代码版本控制、协作开发还是管理代码仓库，Gitnuro 都是一个理想的选择。 | https://github.com/JetpackDuba/Gitnuro |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| Fiddler | Fiddler是一款功能强大的HTTP网页抓包调试工具，它能记录所有客户端和服务器的Http和Https请求，允许你监视，设置断点，甚至修改输入输出数据，使用Fiddler无论对开发还是测试来说，都有很大的帮助。 | https://www.telerik.com/download/fiddler |
...
| WK Proxy | WK Proxy 是一款开源的桌面端 HTTP 代理与抓包工具，支持 Windows 和 macOS 平台，致力于为开发者和测试人员提供简单高效的网络调试体验。 | https://github.com/catas-w/WK-Proxy |
|  |  |  |
|  |  |  |
|  |  |  |
...
| QuickDesk | QuickDesk 是首款 AI 原生远程桌面软件，开源免费，内置 MCP (Model Context Protocol) Server，让任何 AI Agent 都能看到和操控远程电脑。它扩展了 AI 计算机使用的范围，从只能操作本机扩展到可以操作世界上任何一台远程设备。 | https://gitee.com/Barryda/QuickDesk |
|  |  |  |
|  |  |  |
...
| DooTask | DooTask 是一款开源在线项目任务管理工具，提供各类文档协作工具、在线思维导图、在线流程图、项目管理、任务分发、即时IM，文件管理等工具，同时消息功能使用非对称加密技术让你的沟通更安全。 | https://gitee.com/aipaw/dootask |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| Everything | Everything是一款高效、易用、功能强大的Windows文件搜索工具。它以其即时的搜索响应、高效的索引机制、精准的匹配算法和简洁的用户界面赢得了广大用户的喜爱。无论是个人用户还是企业用户，都可以通过这款工具来提高文件管理的效率和准确性。 | https://www.voidtools.com/zh-cn/downloads |
| Listary | Listary是一款高效的 Windows 文件搜索工具，它以极其轻量化的状态运行，能帮你快速查找本地的文件和应用程序。与Everything不同，Listary不仅限于文件名的查找，还可以用于应用启动和联网搜索，适合那些希望提高整体工作效率的用户。 | https://www.listary.com/download |
| AnyTXT Searcher |  AnyTXT Searcher是一款功能强大的本地跨平台（Windows、Linux、MacOS）全文搜索工具，旨在帮助用户快速定位并查找电脑中的各种文档和文本内容。它支持多种文件格式，包括TXT、DOC、PDF、Excel、PPT等，几乎涵盖了日常办公和学习中常见的所有文档类型。| https://anytxt.net/download |
| DocFetcher  | DocFetcher是款开源、跨平台（Windows、Linux、MacOS）的全文搜索工具，它通过创建索引快速查找本地文档中的特定文本，支持PDF、Word、Excel、HTML等多种格式，适合学生、研究人员及文档管理者。 | https://docfetcher.sourceforge.io/zh/download.html |
...
| Fluent Search | Fluent Search 是一款功能强大的搜索工具，可将您 PC 上可搜索的所有内容整合到一个闪电般快速的界面中。即时查找文件、应用程序、浏览器选项卡、Web 内容、打开的窗口等，从而帮助您节省时间并保持高效工作。 | https://apps.microsoft.com/detail/9nk1hlwhnp8s?hl=zh-CN&gl=US |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| PDFPatcher | PDF 补丁丁（PDFPatcher）是一款.NET开源（AGPL）、免费、功能强大的 PDF 处理工具，可以编辑书签、剪裁旋转页面、解除限制、提取或合并文档，探查文档结构，提取图片、转成图片等等，旨在为用户提供便捷、高效的 PDF 编辑和管理体验。 | https://github.com/wmjordan/PDFPatcher |
| PDF24 Tools | PDF24 Tools 是一个免费且易于使用的在线PDF工具，在线PDF综合操作和管理工具。 | https://tools.pdf24.org/zh/all-tools |
...
| Caly | Caly 是一款 .NET 开源免费（MIT license）、轻量快速、跨平台的 PDF 阅读器，工具性能和效率是其核心设计理念。Caly 利用 Avalonia UI、SkiaSharp 和 PdfPig 的强大功能，可在 Windows、macOS 和 Linux 上无缝运行。 | https://github.com/CalyPdf/Caly |
| PDF闪电侠 | PDF闪电侠是一个在线的、功能强大、完全免费在线PDF综合操作和管理工具，提供50多种常用PDF功能。 | https://pdf.ognai.com/ |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| 帮小忙 | 由腾讯出品的在线工具箱：帮小忙，其包含图片工具、PDF转换工具、数据换算工具、生活娱乐工具、教育工具、文本工具、文档转换工具、开发工具、视频工具等多种实用工具。无需下载，打开即用，轻松提升工作与学习效率！ | https://tool.browser.qq.com/ |
...
| Flow Launcher | Flow Launcher是一款.NET开源（MIT License）、免费、功能强大的Windows快速文件搜索和应用程序启动器，能够帮助你快速查找文件、启动应用程序和执行系统操作，提高工作效率和操作便利性。并且生态完善，有插件商店，你可以查看完整的插件列表，或通过"设置"中的"插件商店"菜单快速安装插件。 | https://github.com/Flow-Launcher/Flow.Launcher |
| RightWheel | RightWheel 是一款 Windows 鼠标快捷启动工具。按住鼠标右键并上下滚动，即可快速启动应用程序、触发键盘快捷键、运行 Shell 命令或打开网址，无需键盘操作。支持文件夹子菜单（悬停400ms自动展开）、模板导入、系统托盘运行等功能，免安装、绿色单文件 .exe，支持 Windows 10/11，30 天免费试用。 | https://chautnus.github.io/RightWheel/ |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| DreamScene2 | 	DreamScene2 是一个 .NET开源、免费（MIT license）的小而快并且功能强大的 Windows 动态桌面软件，支持视频和网页动画播放，支持 Windows10/11 系统。 |  https://github.com/he55/DreamScene2 |
| GeekDesk | GeekDesk 是一个小而快并且功能强大的 Windows 动态桌面软件。支持视频和网页动画播放，支持 Windows10/11 系统。| https://github.com/BookerLiu/GeekDesk |
| ImTip | ImTip 提供可编程的「超级热键」系统（智能桌面助手），让您在任何软件中都能一键触发强大功能。所有热键功能均由 aardio 语言编写，您可以轻松修改、扩展，甚至用 AI 自动编写新的热键配置代码，实现无限可能。 | https://github.com/aardio/ImTip |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| frp | frp 是一个基于 Go 开源（Apache-2.0 license）、专注于内网穿透的高性能的反向代理应用，支持 TCP、UDP、HTTP、HTTPS 等多种协议，且支持 P2P 通信。可以将内网服务以安全、便捷的方式通过具有公网 IP 节点的中转暴露到公网。 | https://github.com/fatedier/frp |
...
| EasyTier | EasyTier 是一个由 Rust 和 Tokio 驱动的简单、安全、去中心化的异地组网方案 | https://github.com/EasyTier/EasyTier |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| halo | Halo 是一款强大易用的开源建站工具，从个人博客、知识库，到企业官网、在线商城，Halo 都能助您轻松实现，一站式满足您的多样化建站需求。 | https://github.com/halo-dev/halo |
|  |  |  |
|  |  |  |
|  |  |  |
|  |  |  |
...
|                工具名称                |                           工具详细介绍                           |           工具开源、下载地址            |
| :-------------------------------------------: | :----------------------------------------------------------: | :-------------------------------: |
| KnowStreaming | Know Streaming 是一套云原生、开源（AGPL-3.0 license）的 Kafka 管控平台，脱胎于众多互联网内部多年的Kafka运营实践经验，专注于Kafka运维管控、监控告警、资源治理、多活容灾等核心场景。在用户体验、监控、运维管控上进行了平台化、可视化、智能化的建设，提供一系列特色的功能，极大地方便了用户和运维人员的日常使用，让普通运维人员都能成为Kafka专家。 | https://github.com/didi/KnowStreaming |
| Kafka-King | Kafka-King 是一款开源（Apache-2.0 license）、现代化、实用的 Kafka GUI 客户端，旨在通过直观的桌面界面简化 Apache Kafka 管理。作为一款跨平台应用程序，它为开发人员和管理员提供了强大的工具，可与 Kafka 集群交互，无需依赖命令行界面或基于 Web 的解决方案。 | https://github.com/Bronya0/Kafka-King |
| Kafbat UI | Kafbat UI 是一个免费的开源（Apache License） Web 用户界面，用于监控和管理 Apache Kafka 集群。它功能丰富、运行速度快且轻量。 | https://github.com/kafbat/kafka-ui |
| kouncil | Kouncil 是一款现代化的 Web 界面工具，可让你监控和管理 Apache Kafka 集群。它是一款免费、开源（GPL-3.0 license）的 Kafka Web UI，功能丰富且易于设置！这款简洁的 Kafka 工具可让您的数据清晰可见，帮助你排查问题并提供最佳解决方案。你可以轻松监控代理及其状态、消费者组及其速度以及当前延迟，或者直接实时查看主题内容。 | https://github.com/Consdata/kouncil |
|  |  |  |
|  |  |  |
...
| EFCore.Visualizer（免费） | 一款可以直接在Visual Studio中查看EF Core查询计划调试器可视化工具（帮助开发者分析和优化数据库查询性能），目前，该可视化工具支持 SQL Server、PostgreSQL、SQLite、MySQL 和 Oracle。 | https://marketplace.visualstudio.com/items?itemName=GiorgiDalakishvili.EFCoreVisualizer |
...
| CodeBuddy（免费） | 腾讯云代码助手（Tencent Cloud CodeBuddy，以下简称 CodeBuddy），由腾讯云自研的一款开发编程提效辅助工具，基于腾讯混元 + DeepSeek 双轮模型驱动，构建对开发者友好，好用易用的代码助手，为开发者提供 AI 技术问答、Craft 软件编码智能体、智能代码补全、单元测试、智能评审、代码修复等 Agent 智能体拓展能力，兼容 MCP 开放生态，并可支持团队知识库管理、自定义智能体与指令管理、多模型接入、企业账号集成等功能，辅助开发者提升编码效率和质量，助力研发团队提质增效。 | https://marketplace.visualstudio.com/items?itemName=Tencent-Cloud.coding-copilot-vs |
...
| Claude Code Extension for Visual Studio（免费） | 这是一款 Visual Studio .NET 扩展插件，旨在为 Claude Code CLI 提供更友好的交互界面。它支持多行提示词输入，并允许附加图片和文件。此外，该插件还兼容 Codex、Cursor、Qwen（通义千问）和 Opencode 等大模型。内置的差分（Diff）工具可帮助用户便捷地审查 AI 智能体所做的代码变更。 | https://marketplace.visualstudio.com/items?itemName=dliedke.ClaudeCodeExtension |
| .NET Upgrade Assistant（免费） | .NET 升级助手是一款旨在帮助用户现代化 .NET 应用的工具。从 Visual Studio 17.14.17 及以后版本开始，你不再需要安装这个扩展。升级助手现在内置在 Visual Studio 中。 | https://marketplace.visualstudio.com/items?itemName=ms-dotnettools.upgradeassistant |
| NuGet Package Manager（免费） | NuGet Package Manager 是一款用于自动化从 VS Project 下载、安装、升级、配置和移除包流程的工具集合。 | https://marketplace.visualstudio.com/items?itemName=NuGetTeam.NuGetPackageManager |
|  |  |  |
|  |  |  |
...
| IntelliCode for C# Dev Kit | AI 辅助 C# Dev Kit 开发，此扩展为 C# Dev Kit 用户提供 IntelliCode 成员排名和整行自动完成功能。 | https://marketplace.visualstudio.com/items/?itemName=ms-dotnettools.vscodeintellicode-csharp |
...
| Baidu Comate | 文心快码 ( Baidu Comate ) 是一款由百度推出的创新型 AI 编码辅助工具，它利用先进的人工智能技术，旨在为您带来前所未有的流畅、直观且上下文驱动的编码体验，助力开发者更轻松地实现宏大的软件项目和创新想法。安装后，它将成为您 IDE 的一部分，您无需切换工具，即可在熟悉的编码区专注于代码编写。同时，文心快码还在侧边栏提供了 Zulu 智能体等功能入口，您可以在侧边栏与 AI 进行更深度的交互，例如进行代码问答、探索 Zulu 的各项能力。 | https://marketplace.visualstudio.com/items?itemName=BaiduComate.comate |
| Lingma | 通义灵码是由阿里云提供的智能编码辅助工具，提供 代码智能生成、智能问答、多文件修改、编程智能体 等能力，为开发者带来高效、流畅的编码体验。同时，我们为提供企业客户提供了企业标准版、专属版，具备企业级场景自定义、私域知识增强等能力，助力企业研发智能化升级。 | https://marketplace.visualstudio.com/items?itemName=Alibaba-Cloud.tongyi-lingma |
| CodeBuddy | 腾讯云代码助手（Tencent Cloud CodeBuddy，以下简称 CodeBuddy），由腾讯云自研的一款开发编程提效辅助工具，基于腾讯混元 + DeepSeek 双轮模型驱动，构建对开发者友好，好用易用的代码助手，为开发者提供AI技术问答、Craft软件编码智能体、智能代码补全、单元测试、智能评审、代码修复等Agent智能体拓展能力，兼容 MCP 开放生态，并可支持团队知识库管理、自定义智能体与指令管理、多模型接入、企业账号集成等功能，辅助开发者提升编码效率和质量，助力研发团队提质增效。 | https://marketplace.visualstudio.com/items?itemName=Tencent-Cloud.coding-copilot |
| Fitten Code | Fitten Code 是一款由 Fitten Tech 开发的大型代码模型驱动的 AI 编程助手。它支持多种语言，包括 Python、JavaScript、TypeScript、Java、C、C++等。使用 Fitten Code，您可以在 Visual Studio Code 的侧边栏中自动完成代码、生成代码、生成注释、编辑代码、解释代码、生成测试、查找错误等。 | https://marketplace.visualstudio.com/items?itemName=FittenTech.Fitten-Code |
| Fynix | Fynix Code Assistant 是一个先进的 AI 编程平台，提升您的编程体验。无论是编程、测试还是代码审查，它都能在您的开发环境中提供实时 AI 辅助，支持 Python、JavaScript、TypeScript、Java、PHP、Go 等语言。 | https://marketplace.visualstudio.com/items?itemName=Fynix.fynix |
| Cline | 一个可以使用你的 终端 和 编辑器 的 AI 助手。 | https://marketplace.visualstudio.com/items?itemName=saoudrizwan.claude-dev |
| GitHub Pull Requests | 能够直接在 VS Code 中审查和管理您的 GitHub 拉取请求和问题。| https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github |
| SQL Server (mssql) | Visual Studio Code 的 MSSQL 扩展旨在通过提供无缝且现代的数据库开发体验来赋能开发者。我们的目标是使 SQL 开发更加高效和直观，通过集成诸如架构管理、查询执行和 AI 驱动的辅助等基本功能。 | https://marketplace.visualstudio.com/items?itemName=ms-mssql.mssql |
| CodeSnap | 能够在 VS Code 中快速截取代码的美丽屏幕截图。 | https://marketplace.visualstudio.com/items?itemName=adpyke.codesnap |
| TranslationToolbox | 翻译工具箱，使得文本翻译更加方便快捷，启用快捷键： ctrl+alt+t or cmd+alt+t。 | https://marketplace.visualstudio.com/items?itemName=WLY.translationtoolbox |
| 驼峰翻译助手 | 快速将中文变量翻译名转换为多种常用驼峰命名格式（如 camelCase、PascalCase、snake_case 等）。同时，支持 腾讯 百度 OpenAI API 自定义翻译模型提升开发效率。 | https://marketplace.visualstudio.com/items?itemName=svenzhao.var-translation |
| Du I18N | VS Code国际化多语言解决方案。 | https://marketplace.visualstudio.com/items?itemName=DewuTeam.du-i18n |
...
| Better Comments | 更好的注释扩展将帮助您在代码中创建更人性化的注释。使用此扩展，您将能够将注释分类为：警报、查询、待办事项、强调、注释掉的代码也可以设置样式，以使代码不应该存在、您可以在设置中指定任何其他注释样式。 | https://marketplace.visualstudio.com/items?itemName=aaron-bond.better-comments |
...
| Drawio Preview | 在 VS Code 中预览 Drawio 图文件。 | https://marketplace.visualstudio.com/items?itemName=purocean.drawio-preview |
...
| Vue 3 Snippets | 这个插件包含了所有的 Vue.js 2 和 Vue.js 3 的 api 对应的代码片段。插件的代码片段如下表格所示，你不需要记住什么snippets，就像往常一样在 vscode 里写代码就好了。比如你可以键入 vcom 然后按上下键选中 VueConfigOptionMergeStrategies 再按Enter键，就输入了Vue.config.optionMergeStrategies了。 | https://marketplace.visualstudio.com/items?itemName=hollowtree.vue-snippets |
...
| Vue VSCode Snippets | 该插件旨在为开发者提供最简单快速的生成 Vue 代码片段的方法，通过各种快捷键就可以在 .vue 文件中快速生成各种代码片段。 | https://marketplace.visualstudio.com/items?itemName=sdras.vue-vscode-snippets |
