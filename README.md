...
|  |  |  |
|  |  |  |
| Commitment Issues | A free, open-source web app that scans any GitHub repo for abandonment signals and issues a satirical death certificate with cause of death, last commit date, and contributor analysis. Useful before depending on a project. MIT-licensed, no signup. | https://commitmentissues.dev / [Source](https://github.com/dotsystemsdevs/commitmentissues) |
