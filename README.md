...
| 8码快传 | 8码快传是一款免费、免安装、免登录的浏览器点对点大文件极速传输工具，文件不经服务器中转。桌面 Chrome / Edge 单文件最高支持 200 GB，并支持最多 20,000 个文件的文件夹；传输双方需保持在线。 | https://t.8ma.co/zh/?from=github-ysg-awesome-tools |
|  |  |  |
|  |  |  |
|  |  |  |
